...
group1 = Groups(open_time = time(3,22,00), close_time = time(18,00,00))
...
start_time = datetime(2018, 11, 28, 23, 55, 59, 342380),
end_time = datetime(2018, 11, 29, 23, 55, 59, 0),
...
start_time = datetime(2018, 4, 28, 23, 55, 59, 342380),
end_time = datetime(2018, 11, 29, 23, 55, 59, 0),
room = room1, passed = False)
...
if __name__ == '__main__':
    findEarliest(room1)
    print(isLater(datetime(2019, 4, 28, 23, 55, 59, 342380), datetime(2019, 11, 29, 23, 55, 59, 0)))
